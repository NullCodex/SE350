...
extern void *k_non_blocking_receive_message(int *p_pid);
#define non_blocking_receive_message(p_pid) _non_blocking_receive_message((U32)k_receive_message, p_pid)
extern void *_non_blocking_receive_message(U32 p_func, void *p_pid) __SVC_0;
